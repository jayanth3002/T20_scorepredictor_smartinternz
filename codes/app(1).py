...
#SET PAGE WIDE
st.set_page_config(page_title='T20_Score_Predictor(ipl)',layout="centered")
...
st.markdown("<h1 style='text-align: center; color: white;'>T20 Score Predictor(Ipl) 2023 </h1>", unsafe_allow_html=True)
